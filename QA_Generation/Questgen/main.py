#this entire module was taken from https://github.com/ramsrigouthamg/Questgen.ai
#author Ramsri Goutham Golla
#License: https://github.com/ramsrigouthamg/Questgen.ai/blob/master/LICENSE
...
class QGen:
    ...
    def predict_shortq(self, payload, numQs):
        inp = {
            "input_text": payload.get("input_text"),
            "max_questions": numQs
        }
